        ...
        <div className="container">
                    ...
                    {!username ? (
                        ...
                        <div className="card mb-4" style={{ backgroundColor: '#F7E7CE' }}>
                            <div className="card-body">
                                ...
                                <p className="card-text">We're glad to see you again. You can now create a new request or browse through our legal resources.</p>
            ...
            <footer className="py-3">
                <div className="container text-center">
                    <h5>Contact Us</h5>
                    <p>
                        Address: Liberty Avenue, Uzhorod, Ukraine<br />
                        Phone: +380660370880<br />
                        Email: camel.legalcompany@gmail.com
                    </p>
                    <p>&copy; 2023 LegalCompany website. All rights reserved.</p>
                </div>
            </footer>
        </div>
    );
